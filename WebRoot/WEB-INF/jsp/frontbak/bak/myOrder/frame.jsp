...
<html>
<body class="mobile">
	<form id="form1" name="form1" method="post" action="myOrderList.html"
		target="query">
		...
		<table class="mobile">
			...
			<tr class="pagesearch" height="5%">
				<td style="text-align: left;"><input type="button" class="btn"
					value="刷 新" onClick="sch();" /> &nbsp;&nbsp;<c:choose>
	...
	<script>
		sch();
		function sch() {
			form1.action = "myOrderList.html?flag=${param.flag}";
			form1.submit();
		}
		function keylog() {
		...
		function add() {
			MyWindow.OpenCenterWindow('myOrderEdit.html?flag=${param.flag}', 'addOld',
					500, 600);
		}
	</script>
</body>
